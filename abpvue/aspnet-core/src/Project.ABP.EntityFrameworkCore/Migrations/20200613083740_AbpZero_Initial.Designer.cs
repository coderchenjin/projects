...
namespace Project.ABP.Migrations
{
    ...
    [Migration("20200613083740_AbpZero_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.ABP.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project.ABP.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Project.ABP.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Project.ABP.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Project.ABP.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Project.ABP.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Project.ABP.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Project.ABP.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Project.ABP.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
